...
namespace winrt::estimate1
{
    ...
    struct WallEdge
    {
        WorldPoint Start;
        WorldPoint End;
        bool IsExterior{ true };    // ������� (true) ��� ���������� (false) �����
    };
    ...
    struct JoinInfo
    {
        ...
        uint64_t WallId1{ 0 };
        uint64_t WallId2{ 0 };
        bool Wall1AtStart{ true };          // ���������� � ������ (true) ��� ����� (false) Wall1
        bool Wall2AtStart{ true };          // ���������� � ������ (true) ��� ����� (false) Wall2
        WorldPoint JoinPoint{ 0, 0 };       // ����� ����������� ����
        double Angle{ 0.0 };                // ���� ����� ������� (�������)

        // ����������� ����� ����
        std::vector<WorldPoint> CornerPoints;   // ����� ��� ��������� ����
    ...
    struct JoinSettings
    {
        ...
        double JoinTolerance{ 50.0 };           // ������ ������ ���������� (��)
        JoinStyle DefaultStyle{ JoinStyle::Miter };
        bool ShowJoinPreview{ true };           // ���������� ������ ����������
        bool ExtendToMeet{ true };              // �������� ����� �� �����������
    };
        ...
        JoinInfo DetectJoinType(const Wall& wall1, bool wall1AtStart, const Wall& wall2) const
        {
            ...
            if (distToWall2 < tolerance)
            {
                ...
                if (distToStart2 > minEndDist && distToEnd2 > minEndDist)
                {
                    ...
                    result.Wall2AtStart = false;    // T-join �� �������� � ������
    ...
    public:
            ...
            const JoinInfo& join)
        {
            ...
            Windows::UI::Color textColor = (std::abs(angleDeg - 90.0) < 1.0)
                ? Windows::UI::ColorHelper::FromArgb(255, 0, 150, 0)     // ������ ��� 90�
                : Windows::UI::ColorHelper::FromArgb(255, 200, 100, 0); // ��������� ��� ������
